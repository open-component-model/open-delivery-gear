# ADR 006: Optimisations for Rescoring API

| Status   | Proposed                                   |
|----------|--------------------------------------------|
| Date     | 2026-07-27                                 |
| Deciders | Chris Schneider, Philipp Heil, Jonas Brand |
...
* Breaks current contract that a finding is "stable" and rescorings are only an overlay
